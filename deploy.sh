...
# If this secret already exists from cluster-setup, patch only the keys we own.
# If it doesn't exist yet (fresh cluster), create it.
echo "Ensuring shared-postgres-secret has KIDSTASKS_* keys..."
