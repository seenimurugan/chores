...
## Corpus Check
- 74 files · ~18,423 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 574 nodes · 795 edges · 58 communities (42 shown, 16 thin omitted)
- Extraction: 92% EXTRACTED · 8% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a52fdb38`
...
4. `api` - 9 edges
5. `AdminTaskController` - 9 edges
6. `of()` - 9 edges
7. `PreAuthorize` - 9 edges
...
Cohesion: 0.11
Nodes (21): AssignedTaskRow, AdminMatrix, KidMatrix, KidStats, List, LocalDate, Long, TaskAssignmentRepository (+13 more)
...
Cohesion: 0.14
Nodes (16): List, Long, User, CreateKidRequest, DeleteMapping, GetMapping, PatchMapping, PostMapping (+8 more)
...
## Knowledge Gaps
- **226 isolated node(s):** `PostToolUse`, `SessionStart`, `Steps`, `Tips`, `Token Efficiency Rules` (+221 more)
...
- **What connects `PostToolUse`, `SessionStart`, `Steps` to the rest of the system?**
